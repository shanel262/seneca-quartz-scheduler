...
module.exports = function(options) {
  ...
  seneca.add({role: 'scheduler', cmd: 'update'}, function(args, done) {
    ...
    scheduler.update(schedulerUniqueId, args.when, args.args, {key: args.jobId}, function(err, jobId) {
  ...
  seneca.add({init: name}, function(args, done) {
    ...
    scheduler.start(function() {
      scheduler.addListener(schedulerUniqueId, function(args, callback) {
